...
\textbf{Expert}\\
Python \textbullet{} SQL \textbullet{} Apache Airflow \textbullet{} Spark \textbullet{} Hadoop \textbullet{} \\\\
...
\section{Experience}
\runsubsection{Meta}
\descript{Data Engineer [Onsite]}
\location{Jul 2021 - Present | Menlo Park, CA}
...
% \location{Sept 2018 - Present | San Diego, CA}
% \vspace{\topsep} % Hacky fix for awkward extra vertical space
% \begin{tightemize}
