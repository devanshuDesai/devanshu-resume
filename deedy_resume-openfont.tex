...
\urlstyle{same}
\href{https://github.com/devanshuDesai}{github.com/devanshuDesai} | (408) 230 - 7887 | \href{mailto:dbdesai@ucsd.edu}{dbdesai@ucsd.edu}
}
...
\location{March 2021| San Diego, CA}
Magna Cum Laude\\
...
\begin{tightemize}
\item \emph{Collaborated} with post-doctoral researchers under \textbf{\href{https://scholar.google.com/citations?user=1P8Zu04AAAAJ}{Hao Su}}.
\item \emph{Customized} \textbf{Facebook AI Research}'s
    \emph{\href{https://arxiv.org/abs/1904.09664}{VoteNet}} model to work on a
    novel dataset.
\end{tightemize}
\sectionsep
